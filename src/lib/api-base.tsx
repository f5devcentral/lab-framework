  ...
  return (
    <div className="flex flex-col">
      ...
      <div
        ...
        }${state.status || state.error ? " h-14 p-4 mt-4" : ""}`}
      >
        {state.status && (
          <span className="text-green-600 font-bold inline-block align-middle">
            Status: 200
          </span>
        )}
        {state.error && (
          <span className="text-red-600 font-bold inline-block align-middle">
            Error: {state.error}
          </span>
        )}
      </div>
